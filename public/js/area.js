...
DSYSELDOM = ["s_province","s_city","s_county"];//三个select的name
var opt0 = ["省 份","城 市","市、县"];//初始值
function _init_area(option){  //初始化函数
    DSYSELDOM = option
    for(i=0;i<option.length-1;i++){
        document.getElementById(option[i]).onchange=new Function("change("+(i+1)+")");
    }
    change(0);
}